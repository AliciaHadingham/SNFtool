...
#' 
#' Essentially used to construct a vector or a matrix with colors used as for
#' the ColSideColors argument in the displayClustersWithHeatmap function. See
#' the displayClustersWithHeatmap()'s example.
#' 
#' @param group A numeric vector containing the groups information such as the
#' result of the spectralClustering function.
#' @param colors a vector of colors to be used for the different groups. If the
#' number of group is > 8, the user will have to use the colors argument and
#' give a vector of colors with length at least equal to the number of groups.
#' @return A character vector of colors, corresponding to the given vector of
#' group, keeping the same order.
