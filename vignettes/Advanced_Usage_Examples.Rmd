---
title: "Advanced_Usage_Examples"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Example session from original README}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

This vignette shows an example session from the original SNF readme.
...
Data1 is of size n x d1, where n is the number of patients, d1 is the number of genes, e.g.
Data2 is of size n x d2, where n is the number of patients, d2 is the number of methylation, e.g.
...
Calculate the pair-wise distance; If the data is continuous, we recommend to use the function "dist2" as follows; this calculates squared euclidian distance.
